...
export function Hero() {
  return (
    <>
      ...
      <section className="relative bg-[#FFFFFF] py-20 lg:py-32 overflow-hidden">
        <video
          autoPlay
          loop
          muted
        ...
        >
          <source
            src="https://res.cloudinary.com/dcm0m5nrt/video/upload/v1764420000/wave-bg_vsq1pa.mp4"
            type="video/mp4"
          />
        </video>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="mb-8 sm:mb-10 text-4xl lg:text-6xl tracking-tight text-gray-900">
              <span
                ...
                style={{
                  ...
                  textShadow: "0 0 0.5px #3b82f6",
                }}
              >
                Intelligent Property Strategies
              </span>
              <br />
              <span className="text-gray-900 mt-4 inline-block">
                with AI Guidance
              </span>
            </h1>

            <p className="mb-16 sm:mb-8 text-lg lg:text-xl text-gray-700 max-w-2xl mx-auto">
              Get instant, personalized property investment strategies and guidance
              from our advanced AI agent. Make informed decisions with real practical
              advice and expert analysis.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                asChild
                size="lg"
                className="w-auto inline-flex items-center gap-2 bg-transparent border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-lg font-medium transition-all duration-300"
              >
                <a href="/#demo">
