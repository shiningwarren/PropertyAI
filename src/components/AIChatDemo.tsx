  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hello! I'm your AI Property Strategist. I deliver instant, personalized property investment strategies and guidance. Whether you're exploring buy-to-let, navigating compliance, or planning your next move—I'm here to help. How can I support you today?",
    },
  ]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setMessages((prev) => [
      ...
      { role: "user", content: input },
      {
        role: "assistant",
        content:
          "Thank you for your question! In a real implementation, I would analyze your query using advanced property market data, local insights, and personalized recommendations. This is a demo interface showing how our AI agent would respond to your property-related questions.",
      },
    ]);
    setInput("");
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-500">
              Experience intelligent property consultation. Ask questions and get
            ...
            <div className="lg:col-span-2">
              <Card className="h-[500px] flex flex-col border border-gray-300">
                ...
                <CardContent className="flex-1 flex flex-col p-0 min-h-0">
                  <div
                    className="flex-1 overflow-y-auto px-4 pt-4 pb-4 space-y-4 max-h-[400px]"
                  ...
                  <form
                    ...
                    className="px-4 pt-6 pb-0 border-t border-gray-300 flex gap-2 flex-shrink-0 items-center justify-center"
                  >
                    ...
                    <Button
                      ...
                      size="icon"
                      variant="primary"
                      className="focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:shadow-lg focus-visible:shadow-blue-500/50"
                    >
